...
CREATE INDEX idx_course_schedules_end_date ON course_schedules(end_date);
CREATE INDEX idx_course_schedules_status ON course_schedules(status);
CREATE INDEX idx_course_schedules_grade_levels ON course_schedules USING GIN (grade_levels);
CREATE INDEX idx_course_schedules_strands ON course_schedules USING GIN (strands);
CREATE INDEX idx_course_schedules_sections ON course_schedules USING GIN (sections);
...
COMMENT ON COLUMN course_schedules.sections IS 'Array of sections';
COMMENT ON COLUMN course_schedules.grade_levels IS 'Array of grade levels';
COMMENT ON COLUMN course_schedules.strands IS 'Array of SHS strands';
COMMENT ON COLUMN course_schedules.batch_numbers IS 'Array of TESDA batch numbers';
