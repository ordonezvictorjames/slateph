-- Final fix for create_user_account function
-- Date: February 27, 2026

-- Drop all versions
DROP FUNCTION IF EXISTS create_user_account(TEXT, TEXT, TEXT, TEXT, TEXT) CASCADE;
...
BEGIN
  ...
  -- Create profile with enum variable
