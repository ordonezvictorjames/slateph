...
export default function LoginForm() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Determine role - set as guest for new accounts
      const role = 'guest'
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-12 border-2 border-black rounded-xl focus:border-black focus:ring-0 focus:outline-none focus-visible:outline-none focus-visible:ring-0 w-full px-4 pr-12 text-black"
                  required
                />
                <button
                  type="button"
