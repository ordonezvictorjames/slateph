  -- =============================================
  -- UPDATE AUTHENTICATE USER FUNCTION
  -- Add banner_url and spotify_url to returned user data
  -- =============================================

  -- Drop existing function
  DROP FUNCTION IF EXISTS authenticate_user CASCADE;

  -- Recreate function with banner_url and spotify_url
  ...
  BEGIN
    ...
    -- Return success with user data including banner_url and spotify_url
    RETURN json_build_object(
      'success', TRUE,
